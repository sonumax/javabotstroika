...
import com.sonumax2.javabot.commands.helper.AdvanceCb;
import com.sonumax2.javabot.commands.helper.CbParts;
import com.sonumax2.javabot.commands.helper.Command;
import com.sonumax2.javabot.model.AdvanceDraft;
import com.sonumax2.javabot.model.operation.Operation;
import com.sonumax2.javabot.model.operation.OperationType;
...
public class AdvanceCommand implements Command {
    ...
    public boolean canHandle(Update update) {
        if (update.hasCallbackQuery() && update.getCallbackQuery().getData() != null) {
            ...
            if (AdvanceCb.isConfirmPick(data)) {
                ...
                // остальные confirm-кнопки — только на экране подтверждения
    ...
    private void saveAdvance(long chatId, int messageId) {
        ...
        goToMainMenu(chatId, messageId, "saved", op.getAmount(), op.getOpDate());
    }
